...
module.exports = {
    ...
    RABBITMQ_QUEUE_LOGS: process.env.RABBITMQ_QUEUE_LOGS,
    RABBITMQ_QUEUE_PROMPTS: process.env.RABBITMQ_QUEUE_PROMPTS,
    RABBITMQ_ROUTING_KEY_LOGS: process.env.RABBITMQ_ROUTING_KEY_LOGS,	
    RABBITMQ_ROUTING_KEY_PROMPT: process.env.RABBITMQ_ROUTING_KEY_PROMPT,
