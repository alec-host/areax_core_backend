...
const errorStoreService = (DATABASE_DIALECT && DATABASE_DIALECT !== 'mongo')
    ? require("../user/error/store.pg.system.error")
    : require("../user/error/store.mongo.system.error");
        ...
        try {
            ...
            if (email_found > 0) {
                ...
                if (reference_number_found > 0) {
                    ...
                    await errorStoreService.saveSystemErrors(payload);
                    res.status(200).json({
                        success: true,
                        error: false,
