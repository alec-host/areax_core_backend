...
exports.UserSignUp = async(req,res) => {
        ...
        if(errors.isEmpty()) {
			...
			const newUser_ = { reference_number,google_user_id,username,email,display_name,profile_picture_url,guardian_picture_url,access_token,refresh_token,password:hashedPassword };   
			const newUser = {
    ...
    caption: "Hello World",
    guardian_picture_url: "https://example.com/guardian.jpg",
    tier_reference_number: "TIER123",
    country: "USA",
    city: "New York",
    ...
    token_id: "token123",
    hashed_token_id: "hashed_token123",
    ...
    is_deleted: 0
		            ...
		            //const newUser = { reference_number,google_user_id,username,email,display_name,profile_picture_url,guardian_picture_url,access_token,refresh_token,password:hashedPassword };		
